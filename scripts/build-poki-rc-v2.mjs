...
const version = `poki-rc-v2+${sourceCommit.slice(0, 12)}`
...
const zipPath = path.join(root, 'night-market-poki-rc-v2.zip')
execFileSync('pwsh', ['-NoProfile', '-File', 'scripts/package-poki-rc.ps1', '-SourceDirectory', dist, '-ZipPath', zipPath, '-Version', 'v2'], { stdio: 'inherit' })
...
const manifest = {
  ...
  supersedes: { filename: 'night-market-poki-rc-v1.zip', sha256: '988c2fb001094a826fd4d86ca90e356a1743d98efbd2f622d2904651662c4e77', status: 'OBSOLETE' },
...
await writeFile('releases/poki-rc-v2-manifest.json', JSON.stringify(manifest, null, 2) + '\n')
await writeFile('releases/night-market-poki-rc-v2.zip.sha256', `${manifest.zip.sha256}  ${manifest.zip.filename}\n`)
