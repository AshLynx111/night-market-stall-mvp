import classicDish from '../assets/runtime/menu/dishes/dish-classic-noodle.webp'
import bigEaterDish from '../assets/runtime/menu/dishes/dish-big-eater-noodle.webp'
import orleansDish from '../assets/runtime/menu/dishes/dish-orleans-chicken-noodle.webp'
import signatureDish from '../assets/runtime/menu/dishes/dish-signature-cheese-turkey-noodle.webp'
import tenderloinDish from '../assets/runtime/menu/dishes/dish-tenderloin-turkey-noodle.webp'
import bacon from '../assets/runtime/menu/ingredient-bins/ingredient-bin-bacon.webp'
import cheese from '../assets/runtime/menu/ingredient-bins/ingredient-bin-cheese.webp'
import chiliPowder from '../assets/runtime/menu/ingredient-bins/ingredient-bin-chili-powder.webp'
import cilantro from '../assets/runtime/menu/ingredient-bins/ingredient-bin-cilantro.webp'
import corn from '../assets/runtime/menu/ingredient-bins/ingredient-bin-corn.webp'
import egg from '../assets/runtime/menu/ingredient-bins/ingredient-bin-egg.webp'
import enoki from '../assets/runtime/menu/ingredient-bins/ingredient-bin-enoki.webp'
import hotDog from '../assets/runtime/menu/ingredient-bins/ingredient-bin-hot-dog.webp'
import noodleSheet from '../assets/runtime/menu/ingredient-bins/ingredient-bin-noodle.webp'
import onion from '../assets/runtime/menu/ingredient-bins/ingredient-bin-onion.webp'
import orleansChicken from '../assets/runtime/menu/ingredient-bins/ingredient-bin-orleans.webp'
import sauce from '../assets/runtime/menu/ingredient-bins/ingredient-bin-sauce.webp'
import scallion from '../assets/runtime/menu/ingredient-bins/ingredient-bin-scallion.webp'
import tenderloin from '../assets/runtime/menu/ingredient-bins/ingredient-bin-tenderloin.webp'
import turkeyNoodle from '../assets/runtime/menu/ingredient-bins/ingredient-bin-turkey-noodle.webp'
